...
ROOM_POLYGONS = {
    # ==================== GROUND FLOOR (z=0) ====================
    # Single Adjacent Row: Fashion Hub -> Mega Supermarket
    "A_L0_Entrance":    {"z": 0, "coords": [[10, 5],  [30, 5],  [30, 25], [10, 25]], "color": "#708090"},
    "Fashion Hub":      {"z": 0, "coords": [[10, 25], [30, 25], [30, 60], [10, 60]], "color": "#E6E6FA"},
    "Mega Supermarket": {"z": 0, "coords": [[30, 25], [80, 25], [80, 60], [30, 60]], "color": "#98FB98"},
    "A_L0_Lobby":       {"z": 0, "coords": [[30, 5],  [80, 5],  [80, 25], [30, 25]], "color": "#B0C4DE"},
    "A_L0_Info":        {"z": 0, "coords": [[35, 10], [55, 10], [55, 20], [35, 20]], "color": "#ADD8E6"},
    ...
    # ==================== 1ST FLOOR (z=1) ====================
    # Single Adjacent Row: Tech Gadgets -> Jewel Box -> Book Nook
    "Tech Gadgets":     {"z": 1, "coords": [[10, 10], [30, 10], [30, 35], [10, 35]], "color": "#9370DB"},
    "Jewel Box":        {"z": 1, "coords": [[10, 35], [30, 35], [30, 60], [10, 60]], "color": "#D8BFD8"},
    "Book Nook":        {"z": 1, "coords": [[30, 35], [55, 35], [55, 60], [30, 60]], "color": "#F5DEB3"},
    "A_L1_Hallway":     {"z": 1, "coords": [[30, 10], [80, 10], [80, 35], [30, 35]], "color": "#87CEFA"},
    ...
    # ==================== 2ND FLOOR (z=2) ====================
    # Single Adjacent Row: Cineplex Theater -> VR World & Arcade -> Sky Food Court -> Gourmet Bites
    ...
    "Sky Food Court":   {"z": 2, "coords": [[30, 35], [55, 35], [55, 60], [30, 60]], "color": "#FF7F50"},
    "Gourmet Bites":    {"z": 2, "coords": [[55, 35], [75, 35], [75, 60], [55, 60]], "color": "#F4A460"},
    "B_L2_Corridor":    {"z": 2, "coords": [[30, 10], [80, 10], [80, 35], [30, 35]], "color": "#5F9EA0"},
...
MULTI_CAD_NODES = {
    ...
    "Fashion Hub":      [20.0, 42.5, 0],
    "Mega Supermarket": [55.0, 42.5, 0],
    "A_L0_Lobby":       [55.0, 15.0, 0],
    "A_L0_Info":        [45.0, 15.0, 0],
    "A_L0_Restroom":    [42.5, 45.0, 0],
    "A_L0_Stairs":      [87.5, 17.5, 0],
    "A_L0_Escalator":   [87.5, 37.5, 0],
    "A_L0_Elevator":    [87.5, 57.5, 0],

    # 1st Floor
    "Tech Gadgets":     [20.0, 22.5, 1],
    "Jewel Box":        [20.0, 47.5, 1],
    "Book Nook":        [42.5, 47.5, 1],
    "A_L1_Hallway":     [55.0, 22.5, 1],
    "A_L1_Restroom":    [42.5, 47.5, 1],
    "A_L1_Stairs":      [87.5, 17.5, 1],
    "A_L1_Escalator":   [87.5, 37.5, 1],
    "A_L1_Elevator":    [87.5, 57.5, 1],

    # 2nd Floor
    "Cineplex Theater": [20.0, 22.5, 2],
    "VR World & Arcade":[20.0, 47.5, 2],
    "Sky Food Court":   [42.5, 47.5, 2],
    "Gourmet Bites":    [65.0, 47.5, 2],
    "B_L2_Corridor":    [55.0, 22.5, 2],
    "B_L2_Restroom":    [67.5, 47.5, 2],
    "B_L2_Stairs":      [87.5, 17.5, 2],
    "B_L2_Escalator":   [87.5, 37.5, 2],
    "B_L2_Elevator":    [87.5, 57.5, 2],

    # Parking Lot
    "P_L3_Aisle_Main":  [52.5, 37.5, 3],
    "P_L3_Stairs":      [87.5, 17.5, 3],
    "P_L3_Elevator":    [87.5, 57.5, 3],
    "P1":               [17.5, 19.0, 3],
    "P2":               [34.5, 19.0, 3],
    "P3":               [51.5, 19.0, 3],
    "P4":               [68.5, 19.0, 3],
